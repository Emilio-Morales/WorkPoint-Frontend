...
export default function BentoGrid2({ userSalary, minSalary, maxSalary, avgSalary, department }) {
  const salaryDifference = 50000
  return (
        ...
        <div className="w-full overflow-hidden rounded-lg border border-zinc-950/5 dark:border-white/10">
          ...
          <div className="p-10">
            ...
            <p className="mt-2 text-lg font-medium tracking-tight text-zinc-950 dark:text-white">
              Hilarius Nicholl’s Salary Standing in Product Management
            </p>
            <p className="mt-2 max-w-lg text-sm/6 text-zinc-500 dark:text-zinc-400">
              Compare Hilarius’s salary to the department average, minimum, and maximum
            </p>
          </div>
        </div>
      </div>
      <div className="flex p-px lg:col-span-3 xl:col-span-2">
        <div className="w-full overflow-hidden rounded-lg border border-zinc-950/5 dark:border-white/10">
          <div className="p-10">
            ...
            <p className="mt-2 text-lg font-medium tracking-tight text-zinc-950 dark:text-white">
              Hilarius Nicholl vs. Company Average
            </p>
            <Badge color={salaryDifference > 0 ? 'lime' : salaryDifference < 0 ? 'red' : 'yellow'} className="mt-4">
              {salaryDifference > 0
