...
export default function SessionsChart({ totalBudget, totalActiveBudget, totalInactiveBudget }) {
            ...
            yAxis={[
              {
                ...
                // min: 27000000, // Set an appropriate minimum value that fits your data range
                // max: 200000000,
                // strict: true,
                // scaleType: 'linear',
